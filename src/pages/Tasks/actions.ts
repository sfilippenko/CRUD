...
export interface IEditTask extends IResponseCallbacks {
  formValues: ITaskForm;
  id: number;
}
...
export const editTask = createAction<IEditTask>('EDIT_TASK');
export const editTaskSuccess = createAction<ITask>('EDIT_TASK_SUCCESS');
